...
## Portal NES (algorithm reference only)

- Source: https://github.com/vjroba/portal_nes
- 本プロジェクトはコードをコピーせず、ピクセル境界の立体化という考え方のみを
  参考にした独立実装です。Portal NESの完全移植、設定、プロファイル互換ではありません。
